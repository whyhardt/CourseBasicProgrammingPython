...
# 
# **Your university mail**: g.kallas@uni-osnabrueck.de
# 
# ___
# 
...
class BankAccount:
    ...
    def __str__(self):
        ...
        return f"""
                Number of the bank account: {self.account_number} 
...
account1 = BankAccount("123456789", 8000)
...
class Triangle:
    def __init__(self, a, b, c):
        ...
        self.height = 0.25*self.width*sqrt(sum(sides))
...
rectangle2 = Rectangle(100, 40)

# Calculate and print the perimeter of the rectangle
print(f'Perimeter1: {rectangle1.perimeter()}')
print(f'Area1: {rectangle1.area()}')
print(f'Perimeter2: {rectangle2.perimeter()}')
print(f'Area2: {rectangle2.area()}')
