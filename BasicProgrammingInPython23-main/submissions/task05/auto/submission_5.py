...
student = Student("James", 16, 10)


# In[4]:


print("Name:", student.get_name(student))
print("Age:", student.get_age(student))
print("Grade:", student.get_grade(student))
...
class BankAccount:
    def __init__(self, account_number, balance = 2000):
...
class Circle:
    ...
    def perimeter(self):
        # The formula for perimeter was entered incorrect. It should be (2*pi*r) instead of just (pi*r). In order to make it right, I multiplied the return parameter by 2.
...
counter = 0
# Here, I added start1 in addition to start, so that I can display start1 as the loop starting time at the end. start1 and start are equal.
start1 = datetime(year=2023, month=5, day=22, hour=12, minute=15, second=0)
start = datetime(year=2023, month=5, day=22, hour=12, minute=15, second=0) # Same as start1
...
print(f'Loop started at {start1}.')
print(f'Loop ended at approximately {end}\n')
print(counter)
