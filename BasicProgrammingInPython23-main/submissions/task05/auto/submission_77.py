...
class Triangle:
    ...
    def area(self):
        return 0.5*self.width*self.height #I think there is something wrong with your definition of area. The numbers add up but that is not the area of that circle.
...
class Circle:
    ...
    def perimeter(self):
        return self.radius*pi #this is wrong, the correct formula for the perimeter is 2pi*radius
    
    def area(self):
        return self.radius*pi**2 # this is wrong, the correct formula for the area of the circle is pi*radius**2 
...
# Calculate and print the perimeter of the rectangle
print(f'Perimeter: {circle.perimeter()}') #the correct perimeter for this circle is 31,42
print(f'Area: {circle.area()}')  #the correct area for this circle is 78,54
print(f'Diameter: {circle.diameter()}')  #do I get extra points for noticing the math errors? ;)
...
endtime = datetime(year=2023, month=5, day=22, hour=12, minute=16, second=0)
print(endtime)
