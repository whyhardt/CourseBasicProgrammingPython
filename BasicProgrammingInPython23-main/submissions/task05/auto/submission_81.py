...
class BankAccount:
    ...
    def __str__(self):
        ...
        return f'{self.account_number} has a balance {self.balance}.'
...
counter = 0
start = datetime.now()
endtime = datetime(start.year, start.month, start.day, start.hour, start.minute+1, start.second)
