...
student = Student(input("Name:"), input("Age:"), input("Grade:"))
...
account = BankAccount("123456789", 0) #added 0 as initial balance because otherwise it'd be a TypeError
