...
class Triangle:
    def __init__(self, a, b, c):
        ...
        self.width = #implement width formula here
    ...
    def is_equilateral(self):
        ...
        if #implement equilateral test here
...
print(f'While loop started at {start}.')
print(f'While loop ended at {datetime.datetime.now()}\n')
