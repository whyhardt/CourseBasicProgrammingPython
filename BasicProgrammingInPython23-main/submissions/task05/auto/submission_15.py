...
#nochmal nachschauen, da nicht gerechnet wird    
...
#also initialize balance to make it complete
...
while start<=(datetime.now() + datetime(second=60)):
    counter += 1
