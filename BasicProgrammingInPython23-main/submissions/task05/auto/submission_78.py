...
starttime = datetime(year=2023, month=6, day=4, hour=23, minute=54, second=0)
print(starttime)
...
endtime = datetime(year=2023, month=6, day=4, hour=23, minute=58, second=0)
print(endtime)
