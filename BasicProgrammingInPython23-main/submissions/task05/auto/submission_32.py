...
class BankAccount:
    ...
    def __str__(self): 
        return f"The account {self.acount_number} has a balance of {self.balance}"
...
account = BankAccount("123456789",50000)
...
counter = 0
start = datetime(year=2023, month=6, day=1, hour=16, minute=8, second=0)
