...
class Student:
    def __init__ (this_student, name, age, grade):
        this_student.name = name
        this_student.age = age
        this_student.grade = grade

    def get_name(this_student):
        return this_student.name
    
    def get_age(this_student):
        return this_student.age
    
    def get_grade(this_student):
        return this_student.grade


# In[3]:


student = Student("Anna", 21, 1.8)
