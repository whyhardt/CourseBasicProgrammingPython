...
class Student:
    def __init__(self, name, age, grade): #initialising instances of class
        self.name = name
        self.age = age
        self.grade = grade
...
class BankAccount:
    ...
    def withdraw(self, amount):
        ...
        if self.balance <= 0:
            self.balance = self.balance + self.amount
            return "Insufficient funds, this amount cannot be withdrawn"
...
while datetime.now() - start < minute:
    counter += 1
