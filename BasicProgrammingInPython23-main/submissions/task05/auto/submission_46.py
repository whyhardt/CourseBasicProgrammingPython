...
# **Your name here**: Fynn Drobietz   
# **Your university mail**: fdrobietz@uos.de
# 
# ___
# 
...
class BankAccount:
    def __init__(self,accoint_number, balance):
...
class Rectangle:
    ...
    def perimeter(self):
        return 2*self.heigt * 2*self.widht
...
counter = 0
start = datetime(year=2023, month=6, day=3, hour=12, minute=15, second=0)
