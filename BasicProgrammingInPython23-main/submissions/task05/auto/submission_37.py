...
# **Your university mail**: s.rebers@uni-osnabrueck.de
# 
# ___
# 
...
counter = 0
start = datetime.now()
distance = datetime(year=2023, month=1, day=1, hour=1, minute=1, second=0)- datetime(year=2023, month=1, day=1, hour=1, minute=0, second=0)

while (datetime.now() - start) <= distance:
    counter += 1
