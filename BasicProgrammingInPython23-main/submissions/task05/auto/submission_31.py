...
student_1 = Student("Juanito", 22, 1.2)
student_2 = Student("Camila", 20, 1)
...
print("Name:", student_2.get_name())
print("Age:", student_2.get_age())
print("Grade:", student_2.get_grade())
...
account = BankAccount("123456789", 10)
...
class Triangle:
    ...
    def is_equilateral(self):
        ...
        if self.a == self.b or self.a == self.c or self.b == self.c: #implement equilateral test here
...
class Circle:
    ...
    def diameter(self):
        return 2*self.radius #implement method here
...
#I assuming in this case, that if it doesn't work, it is ok, right? (because of the explanation you gave)
...
counter = 0
start = datetime.now() #implement start time here

while datetime.now() < endtime: #implement condition here:
    counter += 1
