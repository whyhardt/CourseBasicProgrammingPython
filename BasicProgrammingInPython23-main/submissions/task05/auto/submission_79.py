...
student = Student("Johannes", 19, 1.3)
...
class Rectangle:
    ...
    def perimeter(self):
        return 2 * (self.width + self.height) #implement method here
    
    def area(self):
        return self.height * self.width  #implement method here
...
class Triangle:
    ...
    def is_equilateral(self):
        ...
        if  self.a == self.b == self.c: #implement equilateral test here
...
while datetime.now() < start + timedelta (seconds=60):  #implement condition here:
    counter += 1
