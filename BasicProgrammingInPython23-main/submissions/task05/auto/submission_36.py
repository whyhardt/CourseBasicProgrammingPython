...
class Triangle:
    def __init__(self, a, b, c):
        ...
        #The width of a triangle is the length of the longest side (use the max function over a list of all side attributes [self.a,self.b,self.c])
