...
class BankAccount:
    def __init__(account_number, self, balance):
...
# ## Task 3 - GeometricC lasses (5 points)
...
rectangle_a = Rectangle(10, 6)

# Calculate and print the perimeter of the rectangle
print(f'Perimeter: {rectangle_a.perimeter()}')
print(f'Area: {rectangle_a.area()}')
...
# Calculate and print the perimeter of the rectangle
print(f'Perimeter: {circle_a.perimeter()}')
print(f'Area: {circle_a.area()}')
print(f'Diameter: {circle_a.diameter()}')
...
starttime = datetime.datetime(year=2023, month=5, day=22, hour=12, minute=15, second=0)
print(starttime)
...
endtime = datetime.datetime(year=2023, month=5, day=22, hour=13, minute=45, second=0)
print(endtime)
...
end = starttime + datetime.timedelta(minutes=1)
