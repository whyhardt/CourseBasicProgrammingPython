...
class BankAccount:
    ...
    def deposit(self, amount):
        ...
        return f"The account balance after deposit is: {self.balance}"

    
    def withdraw(self, amount):
        if self.balance >= amount:
            self.balance -= amount
            return f"The account balance after withdrawal is: {self.balance}"
        else:
