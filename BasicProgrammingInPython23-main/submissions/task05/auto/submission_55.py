...
while (datetime.now() - start) < timedelta(minutes=1): #datetime(start.year, start.month, start.day, start.hour, start.minute+1, start.second):
    counter += 1
