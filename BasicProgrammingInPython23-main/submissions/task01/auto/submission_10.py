...
# Switch the values using a temporary variable
temp = a
a = b
b = temp

# Print the switched values
print("The switched values are:")
print("a =", a)
print("b =", b)
...
height = 160 # You can change this value to test different scenarios

# Check if the user is tall enough to ride the rollercoaster
if height >= 120:
  # The user is allowed to ride the rollercoaster
  allowed = True

  # Ask the user to enter their age
  # age = int(input("Enter your age: "))
  age = 19 # You can change this value to test different scenarios

  # Check the price based on the age
  if age < 12:
    # The user is younger than 12
    price = 5
  elif age <= 18:
    # The user is between 12 and 18 (inclusive)
    price = 8
  else:
    # The user is older than 18
    price = 15
  ...
  # The user is not allowed to ride the rollercoaster
  allowed = False
