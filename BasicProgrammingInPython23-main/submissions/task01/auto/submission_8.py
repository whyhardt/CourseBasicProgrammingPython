...
#asks to enter numbers and store them in a and b
print("Please enter a number to a")
a = input()
print("Please enter a different number to b")
b = input()

#makes sure to have different numbers stored in a and b
while b == a:
    print("Please enter a number to a")
    a = input()
    print("Please enter a !different! number to b")
...
#switches stored values in a and b   
a, b = b, a
...
#is the person allowed to ride?
if height >= 120:
    allowed = True
    #the price depending on age
    if age < 12:
        price = 5
...
#person is not allowed:
    ...
    allowed = False
    #not allowed, so price is not needed
    price = "not important"
