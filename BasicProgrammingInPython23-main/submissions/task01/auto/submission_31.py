...
# **Your university mail**: lartmann@uni-onsbrueck.de
# ___
# 
...
print(f'The person (height={height},age={age}) is {"not" if not allowed else ""} allowed to take the ride{ f" and their price is {price}€" if allowed else " at the moment"}.')
