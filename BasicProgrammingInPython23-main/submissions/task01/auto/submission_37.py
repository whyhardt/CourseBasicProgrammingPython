...
a = str('hello world') #'hello world' # also can be written as: "hello world", str()
b = int(-19)
c = float(7.29)
d = bool(False)
e = (1,2,4.56)
...
def if_eligible(height,age):
    ...
    if height >= 120:
        ...
        allowed = False
        return  print('allowed = ', allowed,'not eligible!')
    
    return print('allowed = ', allowed,' and ', 'price = ' ,price)


print(if_eligible(160,19) )
