...
# **Your name here**: Nastassia Surma
# **Your university mail**: nsurma@uos.de
# ___
# 
...
my_result_3 = float((a ** 2 + b ** 3) / (1 + c / d))
...
if height >= 120:
    ...
    allowed = False
    print("Sorry, people with hight less than 120 cm can not ride the rollercoaster")

if allowed:
    print(f"You can ride the rollercoaster, the ticket price is {ticket_price} €" )
