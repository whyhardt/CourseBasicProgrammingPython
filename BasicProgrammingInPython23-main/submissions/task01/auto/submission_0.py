...
if height < 120: #check persons height
    allowed = False # set allowed
    print ("I am sorry but you can't ride the rollercoaster")
else: 
    age = int(input("age:"))# asking the allowed people how old they are
    allowed = True
    if age > 18: #price dependent on age
        price = 15
    elif age > 12:
        price = 8
    else: 
