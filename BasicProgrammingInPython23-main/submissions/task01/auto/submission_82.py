...
# Printing variables and variable types to confirm
...
# Changing the value of a to "6" otherwise there would be a negative square root
...
if height >= 120: Allowed = True 
else: Allowed = False
    
if Allowed is True and age < 12: Price = 5
elif Allowed is True and  age <= 18: Price = 8
elif Allowed is True and  age > 18: Price = 15
    
if Allowed is True: print("The person is allowed onto the rollercoaster and they need to pay", Price, "€.")
else: print("The person is not allowed onto the rollercoaster.")
