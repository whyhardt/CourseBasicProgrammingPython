...
if height >= 120:
    allowed = True
    age = int(input("Then you are allowed to ride the rollercoaster. How old are you?"))
    if age >= 18:
        price = 15
    elif age < 12:
        price = 5
        ...
        price = 8
    print("You have to pay %s€." %price)
else:
    allowed = False
    print("I am sorry you are not allowed to ride this rollercoaster. You are allowed as soon as you are taller than 120cm")
