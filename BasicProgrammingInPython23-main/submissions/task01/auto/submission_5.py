...
b = input()
print("I will now switch the values")
c = b
b = a
a = c
print("The first number is now", a, ", the second number is now", b)
print(a, b)
...
print ("Hello! What is your height in cm?")
height = int(input())
if height >= 120:
    allowed = True
...
#i think it doesn't make any sence to ask a person who is shorter that 120 cm about their age, because they are not allowed
#on the rollercoaster regardless of their age. therefore i commented out the suggested output, because it needs to know the age
#even if the age isn't asked. but I put a version in the cell below where the age is asked
