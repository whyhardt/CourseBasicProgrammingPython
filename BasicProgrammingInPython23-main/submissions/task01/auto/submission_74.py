...
height = int(input("Please state your height(in centimeters) : "))
...
if (height >= 120) :
   if (age > 18) :
    print (f'The person (height={height}, age={age}) is allowed to take the ride and their price is 15€.')
   elif (12 <= age <= 18 ) :
    print (f'The person (height={height}, age={age}) is allowed to take the ride and their price is 8€.')
   elif (age < 12) :
    print (f'The person (height={height}, age={age}) is allowed to take the ride and their price is 5€.')
else :
   print (f'The person (height={height}, age={age}) is not allowed to take the ride.')
