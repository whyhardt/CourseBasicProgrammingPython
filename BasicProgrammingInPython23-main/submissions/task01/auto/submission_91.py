...
# price stays 0 if they are not allowed on the ride
price = 0
# allowed stays True unless they are too short
allowed = True

# check if they are tall enough & adjust price accordingly
if (height >= 120):
    if (age < 12):
        price = 5
    elif age <= 18:
        ...
        price = 15
# set allowed to False if they are too short
else:
    allowed = False 
