...
a, b = input("Please enter two different numbers: ").split()
...
if(not allowed) :
    price = 0
    #price = str("not available because of the height")
...
#{"and their price is {price}€" if allowed else ""} --> doesn't work because of price pattern
