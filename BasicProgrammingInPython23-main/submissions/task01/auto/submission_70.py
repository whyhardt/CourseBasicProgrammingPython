...
# I put an explicit declaration with variable type as a comment before each assignment where it's possible, 
# as the task mentions specific data types. I also used prints to check for errors.
...
a = input("Insert number for A")
b = input("Insert number for B")
placeholder = 0
...
if height > 120 :
    ...
    elif age > 18 : price = 15

else: print("Sorry, you're not allowed to ride the rollercoaster. See you next time!")
...
if height > 120 :
    ...
    print(f"Perfect, you're price is {price} € ")

else: print("Sorry, you're not allowed to ride the rollercoaster at this moment. See you next time!")
