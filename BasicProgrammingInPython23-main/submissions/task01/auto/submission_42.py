...
string_a = input("Input a string: ")
string_b = input("Input a shorter string: ")
...
import random
result = shopping_list_fruit[random.randint(0, 5)], shopping_list_dairy[random.randint(0, 1)], shopping_list_sweets[random.randint(0, 2)]
print(result)
...
file__name = ""
if not file_name.isalnum(): #You could of leave out this line and get the same results, but I decided to leave it in because of the task formulation
    for i in file_name :
