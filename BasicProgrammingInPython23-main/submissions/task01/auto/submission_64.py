...
allowed = True if height >= 120 else False
price = 0
...
print(f'The person (height={height},age={age}) is {"not" if not allowed else ""} allowed to take the ride {f"and their price is {price}€." if allowed else "."}')
