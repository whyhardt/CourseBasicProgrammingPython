...
print("a & b before the switch:", a, ",", b)

#create temporary variable for the swap
temp = a
a = b
b = temp

print("a & b after the switch:", a, ",", b)
...
print("What is your height (in cm) & age?")
...
if height <= 120:
    message_neg = "Sorry, you are not allowed to ride the rollercoaster" 
    print(message_neg)
else:
    message_pos = "you are allowed to ride the rollercoaster!"
    print(message_pos)


if height <= 120:
    print("Therefore I cannot sell you a ticket")
elif age < 12:
    print("You have to pay 5€ for the ticket")
elif age <= 18:
    print("You have to pay 8€ for the ticket")
else:
    print("You have to pay 15€ for the ticket")
