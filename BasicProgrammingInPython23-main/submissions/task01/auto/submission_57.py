...
if allowed == False:
    print("I'm sorry, unfortunately you cannot get on this ride yet!")
else:
    print("Great, you're tall enough to get onto this ride! How old are you?")
    age = int(input())
    if age < 12:
        price = 5
    elif age <= 18:
        ...
        price = 15
    print("Okay, that'll be ", price, "€ for the ticket then please!")
