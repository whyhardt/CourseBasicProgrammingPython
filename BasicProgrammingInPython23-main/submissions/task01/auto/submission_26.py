...
g = 9>=9
h = 28*2-14
#print(type(a), type(b), type(c), type(d), type(e), type(f), g, h)
...
b = input("write a different number here")
print("Your first number is:", a, "and you second number is:", b)
c=a
a=b
b=c
print("Now, we switched it, so your first number is:", a, "and you second number is:", b)
...
if allowed== True and age<12:
    price = int(5)
elif allowed==True and age<=18:
    price=int(8)
elif allowed==True and age>18:
    price=int(15)
else:
    price=str("no price, because the person is not allowed")
