...
a = input("Please enter a number for the variable a: ")
b = input("Please enter a number for the variable b: ")
...
if height >= 120:
    ...
    allowed = False
    print(f'The person (height={height},age={age}) is {"not" if not allowed else ""} allowed to take the ride at the moment')
