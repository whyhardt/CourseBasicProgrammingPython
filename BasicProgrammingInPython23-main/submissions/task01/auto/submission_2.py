...
# **Your name here**: Aurica Schleyrbach 
...
#ask user to enter two differnt numbers
a = input("Enter the a number: ")
b = input("Enter the a different number: ")
...
# Ask costumer for height (in cm)
height = int(input("What is your height (in cm)? "))

# Find out, if visitor is tall enough
if height >= 120:
    # If user is tall enough, find out age
    age = int(input("What is your age? "))

    # Adjust ticket price by checking age
    if age < 12:
        price = 5
    elif age <= 18:
        price = 8
    ...
    # visitor is allowed to ride 
    allowed = True
else:
    # visitor is not allowed to ride, if smaller than 120cm, therefore prices do not have to be checked
    allowed = False
    price = None
    print("Unfortunately, you can not ride the rollercoaster at the moment.")
