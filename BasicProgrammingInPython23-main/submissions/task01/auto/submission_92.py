...
#user numbers: first 4, second 3

a = input("Enter a number: ")
b = input("Enter another number: ")
print("Initial user numbers: a =", a,",", "b =", b)
a, b = b, a
print("Switched numbers: a =", a, ",", "b =", b)


# In[9]:


print("The switched values are: a =", a, ",", "b =", b)
...
if height < 120:
    allowed = False
    print("Allowed?:", allowed, "\nYou are not allowed to ride the rollercoaster.")
else:
    allowed = True
    print("Allowed?:", allowed)
    if age < 12:
