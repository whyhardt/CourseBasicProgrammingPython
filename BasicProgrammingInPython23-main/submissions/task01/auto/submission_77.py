...
allowed = False # set on false unless stated otherwise
...
if height < 120:
    print(f'The person (height={height},age={age}) is not allowed to take the ride. Maybe next time!')
if height >=120:
    allowed = True
    if age < 12:
        price = 5
