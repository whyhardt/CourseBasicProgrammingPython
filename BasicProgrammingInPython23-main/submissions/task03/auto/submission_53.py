...
# **Your name here**: Anna Joline Lippold  
# **Your university mail**: alippold@uos.de
# ___
# 
...
for letter in my_string:
    print(letter)
    if letter == 'a' or letter == 'e' or letter == 'i' or letter == 'o' or letter == 'u' or letter == 'A' or letter == 'E' or letter == 'I' or letter == 'U' or letter == 'O':
        vowel_count += 1
...
#Because I did not quite know wether we are supposed to pop the last or first letter I wrote both codes:
#Removing the first letter of the list:
...
#removing the last letter of the list:

alphabet2 = ["A","B","C","D","E","F","G","H"]

removed2 = alphabet2.pop()

print(removed2, " was removed from the alphabet list, which is now: ", alphabet2)
