...
# **Your name here**: David Carranza Navarrete  
...
print(index, " is the index of ", months[index])
...
print("2 appears ", number_2_count, " times in the list.")
...
# 
# Implement a while loop that receives inputs, using, for example, ```    ``` and stores the input in the list ```names```.  
...
print( "Participants are", stored_names)

selected_name = random.choice(stored_names)
