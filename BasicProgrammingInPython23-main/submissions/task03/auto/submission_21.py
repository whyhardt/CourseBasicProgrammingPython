...
#the first answer doesn't count the repeated vowels
#the secong answer counts the total number of all the vowels
...
names = []
ppl=input("Enter a name or 'stop', to stop:")
while ppl!="stop":
    names.append(ppl)
    ppl=input("Enter a name or 'stop', to stop:")
