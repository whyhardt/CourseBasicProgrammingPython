...
# **Your university mail**: krohrberg.person@uos.de
# ___
# 
...
vowel_count = my_string.count("A") + my_string.count("E") + my_string.count("I") + my_string.count("O") + my_string.count("U") + my_string.count("a") + my_string.count("e") + my_string.count("i") + my_string.count("o") + my_string.count("u")       
...
removed = alphabet.pop(len(alphabet)-1)
