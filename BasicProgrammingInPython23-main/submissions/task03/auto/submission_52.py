...
# ? I think you solved this one alread
...
names = ["Donald Duck", "Minnie Mouskey Mouse", "Goofy", "Tick", "Trick", "Track", "Scrooge McDuck", "Daisy De", "Micuck", "Pete", "Pluto"]
names.sort()
print(names)
...
names = []
userInput= input("Enter a name or \'stop\', to stop:")
