...
result = [word for word in python_text if len(word) > 8]
...
alphabet.insert(len(alphabet), removed)
...
print('Please enter a name. If you are finished, press enter without any input.')
while True:
    print('Name: ')
    inp = input()
