...
for c in my_string:
    print(c)
    if c in vs:
        vowel_count += 1 #not sure if we should check for duplicates. as its not stated it doesnt do it
...
while inputs != 'end':
    inputs = input("enter your name pls: ")
    names += [inputs]
