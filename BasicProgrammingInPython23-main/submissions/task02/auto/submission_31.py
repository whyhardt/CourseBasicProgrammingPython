...
string_a = str(input('string a'))
string_b = str(input('string b'))
...
result = shopping_list[shopping_list.index("Cherry")]
print(result)
...
result = [shopping_list_fruit[1]] + [shopping_list_dairy[1]] + [shopping_list_sweets[0]]
print(result)
...
if any(end in file_name[-4:] for end in ['.txt', '.doc', '.pdf']):
    file_type = "Document file"
    
elif any(end in file_name[-4:] for end in ['.jpg', '.png']):
    file_type = "Image file"
    
elif any(end in file_name[-4:] for end in ['.mov', '.mp4']
        ):
