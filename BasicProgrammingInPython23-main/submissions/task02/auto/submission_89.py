...
string_a = input("Enter any string")
string_b = input("Enter another string")

length_a = len(string_a) #variable for length of the first string
length_b = len(string_b) #variable for length of the second string

value_length = True 

'''print(len(string_a)) #checking if the output is right
print(len(string_b))'''

if length_a > length_b: #if a longer than b, print out True
    print(value_length) 
else:
    value_length = False #otherwise print out false
    print(value_length)
...
result = shopping_list_fruit[2] + ", " + shopping_list_dairy[1] + ", " + shopping_list_sweets[0]
print(result)
