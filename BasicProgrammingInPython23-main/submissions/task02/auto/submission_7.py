...
print("Hello! Write the first string!")
string_a = input()
print("Great:) Now the second string")
string_b = input()
...
result = shopping_list[0:2]+shopping_list[4:6]
print(result)
...
result = shopping_list[0:1]+shopping_list[2:3]+shopping_list[4:5]
print(result)
...
result = [shopping_list_fruit[random.randrange(0,6)]]+[shopping_list_dairy[random.randrange(0,2)]]+[shopping_list_sweets[random.randrange(0,3)]]
print(result)
...
if file_name[(len(file_name)-4):len(file_name)]==".txt" or file_name[(len(file_name)-4):len(file_name)]==".doc" or file_name[(len(file_name)-4):len(file_name)]==".pdf":
    file_type = "Document file"
    
elif file_name[(len(file_name)-4):len(file_name)]==".jpg" or file_name[(len(file_name)-4):len(file_name)]==".png":
    file_type = "Image file"
    
elif file_name[(len(file_name)-4):len(file_name)]==".mp4" or file_name[(len(file_name)-4):len(file_name)]==".mov":
