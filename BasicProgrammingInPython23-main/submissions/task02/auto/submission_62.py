...
string_a = input("Please write your first statement! You will be judged:")
string_b = input("Please write your second statement! You will be judged:")

a_longer = bool( len(string_a) > len(string_b))
print(a_longer)
...
result = [shopping_list[0], shopping_list[1], shopping_list[len(shopping_list)-2], shopping_list[len(shopping_list)-1]]
print(result)
