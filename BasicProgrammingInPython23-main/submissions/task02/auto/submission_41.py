...
string_a = input("First Input")
string_b = input("Second Input")
...
result = shopping_list[0:2] + shopping_list[4:]
print(result)
...
#file_name = "Hello@2$ world.mov"
file_name = "Hello)/4  world.jpg"
...
file_title = file_name[0:-4]
if file_title.isalnum() != True:
    special_characters = ["!","@","#","$","%","^","&","*","(",")","-","+","?","=",",","<",">","/"]
...
elif file_name.endswith((".mov",".mp4")):
