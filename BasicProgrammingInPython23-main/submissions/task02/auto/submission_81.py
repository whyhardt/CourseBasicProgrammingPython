...
string_a = input("Your first input: ")
string_b = input("Your second input: ")
...
# I wasn't sure whether we should also delete the elements out of the lists or just creating an output.
# For also deleting them, I would use the pop()-function (in this cell: result = shoppin_list.pop(2))
...
result = [shopping_list[i] for i in (0,1)]
...
result = [shopping_list[i] for i in (0,1,4,5)]
print(result)
...
result = [shopping_list[i] for i in (0,2,4)]
print(result)
...
result = [random.choice(shopping_list_fruit)] + [random.choice(shopping_list_dairy)] + [random.choice(shopping_list_sweets)]
print(result)
...
if file_name[1] == "txt" or file_name[1] == "doc" or file_name[1] == "pdf":
    file_type = "Document file"
    
elif file_name[1] == "jpg" or file_name[1] == "png":
    file_type = "Image file"
    
elif file_name[1] == "mp4" or file_name[1] == "mov" in file_name:
