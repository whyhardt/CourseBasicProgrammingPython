...
string_a = input("Please enter a string for the variable string_a: ")
string_b = input("Please enter a string for the variable string_b: ")
...
for letter in file_name:
    # special characters are characters that are no number, letter or dot.
