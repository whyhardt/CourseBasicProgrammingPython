...
# **Your name here**: Niloofar Nazari  
# **Your university mail**: nnazari@uni-osnabrueck.de
# ___
# 
...
#This is the main answer but the later options are also other ways to do this task.
special=['!','@','#','$','%','^','&','*','(',')','-','_','+','=',':',';','<','>',',','.','?']
...
#this is the code only for the given example
file_name = "Hello, world.txt"
...
#this is the code for ALL of the special characters
file_name = input("enter file name")
if "!" in file_name or "@" in file_name or "#" in file_name or "$" in file_name or "%" in file_name or "^" in file_name or "&" in file_name or "*" in file_name or "(" in file_name or ")" in file_name or "-" in file_name or "=" in file_name or "+" in file_name or "_" in file_name or "?" in file_name or "," in file_name or "<" in file_name or ">" in file_name or "." in file_name or ":" in file_name or ";" in file_name:
    file_name = file_name.replace("!", "_").replace("@", "_").replace("#", "_").replace("$", "_").replace("%", "_").replace("^", "_").replace("&", "_").replace("*", "_").replace("(", "_").replace(")", "_").replace("-", "_").replace("=", "_").replace("+", "_").replace("_", "_").replace("?", "_").replace(",", "_").replace("<", "_").replace(">", "_").replace(".", "_").replace(":", "_").replace(";", "_")
    print(file_name)
else:
    print("no special characters")
    print(file_name)
