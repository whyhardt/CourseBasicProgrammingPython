...
string_a = input("Write some string a: ")
string_b = input("Write some string b: ")
...
#result = shopping_list[:2:] + shopping_list[len(shopping_list)-2:len(shopping_list)]
print(result)
...
if "txt" in file_name[len(file_name)-3::] or "doc" in file_name[len(file_name)-3::] or "pdf" in file_name[len(file_name)-3::]:
    file_type = "Document file"
    
elif "jpg" in file_name[len(file_name)-3::] or "png" in file_name[len(file_name)-3::]:
    file_type = "Image file"
    
elif "mp4" in file_name[len(file_name)-3::] or "mov" in file_name[len(file_name)-3::]:
