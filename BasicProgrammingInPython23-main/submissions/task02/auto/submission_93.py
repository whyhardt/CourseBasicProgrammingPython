...
string_a = str(input("User Input a:"))
string_b = str(input("User Input b:"))
...
result = [shopping_list_fruit[3]] + [shopping_list_dairy[1]] + [shopping_list_sweets[2]]
print(result)
...
real_file_name = file_name[1]
if not real_file_name.isalnum():
    real_file_name.replace(":", "_")
    real_file_name.replace(",", "_")
    real_file_name.replace("$","_")                          
...
if real_file_name.endswith(".txt") or real_file_name.endswith(".doc") or real_file_name.endswith(".pdf"):
    file_type = "Document file"
elif real_file_name.endswith(".jpg") or real_file_name.endswith(".png"):
    file_type = "Image file"   
elif real_file_name.endswith(".mp4") or real_file_name.endswith(".mov"):
