...
# **Your name here**: Fynn Aurand  
# **Your university mail**: faurand@uos.de  
# ___
# 
...
string_a = input('First string:')
string_b = input('Second string:')
...
result = [shopping_list_fruit[::2]]+[shopping_list_dairy[:2]]+[[shopping_list_sweets[-1]]]
print(result)
