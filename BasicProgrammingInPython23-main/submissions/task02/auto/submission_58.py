...
string_a = str(input("Your first text here:"))
string_b = str(input("Your second text here:"))

if string_a > string_b: print("True")
else: print("False")
...
if char.isnumeric() is True:
    ...
    print("The character <", char, "> is neither of the former options.")
...
result = shopping_list[0], shopping_list[1], shopping_list[4], shopping_list[5]
print(result)


# Retrieve every second item of the list, starting from the Apple. ->"Starting from Apple": This means Apple has to be the first one right? ^^ Because strictly speaking Banana would be the first second item. 
...
result = shopping_list[5], shopping_list[4],shopping_list[3], shopping_list[2], shopping_list[1],shopping_list[0] 
print(result)
...
else: file_name2 = file_name1

if "$" in file_name2:
   file_name3 = file_name2.replace("$", "_")
else: file_name3 = file_name2
...
if file_name[-4:] in [".txt", ".doc", ".pdf"]:
    file_type = "Document file"
    
elif file_name[-4:] in [".jpg", ".png"]:
    file_type = "Image file"
    
elif file_name[-4:] in [".mp4", ".mov"]:
