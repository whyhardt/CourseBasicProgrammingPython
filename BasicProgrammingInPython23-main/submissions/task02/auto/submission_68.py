...
string_a = input("Type first sentence: ")
string_b = input("Type second sentence: ")
...
char = input("Type some character: ")
...
result = [shopping_list_fruit[4]]+[shopping_list_dairy[0]]+[shopping_list_sweets[2]]
print(result)
