...
string_a = input("Please enter a string: ")
string_b = input("Please enter another string: ")

#compares if string a is longer than string b
...
result = [shopping_list_dairy[1]] + [shopping_list_fruit[1]] + [shopping_list_sweets[1]]
print(result)
