...
# **Your university mail**: sscheerhorn@uni-osnabrueck.de
# ___
# 
...
# Retrieve a list with at least one vegetable product, fruit, and sweet, by taking elements from each of the presented lists (don't just make a new list, that will not give you points).  
...
shopping_list_vegetable = ["Cucumber", "Zuchinni"] # We don't want to buy dairy
shopping_list_sweets = ["Chocolate", "Popsicle", "Gummy bears"]

result = [shopping_list_vegetable[0]]+[shopping_list_fruit[1]]+[shopping_list_sweets[2]]
print(result)
