...
result = [shopping_list_fruit[2]] + [shopping_list_dairy[0]] + [shopping_list_sweets[3]]
print(result)
...
if any (char in file_name for char in special_characters):
