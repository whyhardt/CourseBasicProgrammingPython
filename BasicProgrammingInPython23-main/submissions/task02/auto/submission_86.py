...
result = [shopping_list_fruit[3]] + [shopping_list_dairy[0]] + [shopping_list_sweets[1]]
print(result)
...
if file_name.split('.')[-1] in ['txt', 'doc', 'pdf']:
    file_type = "Document file"
    
elif file_name.split('.')[-1] in ['jpg', 'png']:
    file_type = "Image file"
    
elif file_name.split('.')[-1] in ['mp4', 'mov']:
