...
string_a = input("Please enter the first string :-")
string_b = input("Please enter the second string :-")
...
result1 = shopping_list.reverse()
result1 = shopping_list
print(result1)

result2 = shopping_list[::1]
print(result2)
