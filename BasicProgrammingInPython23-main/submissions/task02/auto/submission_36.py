...
string_a = input("Please write something down: ")
string_b = input("PLease write something down again: ")
...
result = [shopping_list_fruit[:3], shopping_list_dairy[:2], shopping_list_sweets[1]]
print(result)
...
if ":" in file_name or "," in file_name or "$" in file_name:
    file_name = file_name.replace(":", "_").replace(",", "_").replace("$", "_") # replace the special character with an underscore
