...
help = programmer_joke
programmer_joke = help.split("\n")
...
if char.isalnum() == False: #the statement below is printed if char is NOT alphanumerical
...
if file_name[-4:] == ".txt" or file_name[-4:] == ".doc":
