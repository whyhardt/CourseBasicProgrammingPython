...
programmer_joke = '[' + ',\n'.join(list_of_elements) + ']' #splits list in lines
...
result = shopping_list[0:2] + shopping_list[len(shopping_list)-2:len(shopping_list)]
print(result)
...
result = shopping_list[0] + shopping_list[2] + shopping_list[4]
print(result)
...
idx = len(shopping_list) - 1
result = []

while (idx >= 0):
    result.append(shopping_list[idx])
    idx = idx - 1

print(result)


# Retrieve a list with at least one crueltyfree product, fruit, and sweet, by taking elements from each of the presented lists (don't just make a new list, that will not give you points).  
...
shopping_list_crueltyfree = ["Soy-Joghurt", "Oat-Milk"] #we don't want to buy dairy
shopping_list_sweets = ["Chocolate", "Popsicle", "Gummy bears"]

result = [shopping_list_fruit[0]] + [shopping_list_crueltyfree[1]] + [shopping_list_sweets[2]]  
...
if file_name[len(file_name)-3:len(file_name)]== "txt" or file_name[len(file_name)-3:len(file_name)]== "doc" or file_name[len(file_name)-3:len(file_name)]== "pdf":
    file_type = "Document file"
    
elif file_name[len(file_name)-3:len(file_name)]== "jpg" or file_name[len(file_name)-3:len(file_name)]== "png":
    file_type = "Image file"
    
elif file_name[len(file_name)-3:len(file_name)]== "mp4" or file_name[len(file_name)-3:len(file_name)]== "mov":
