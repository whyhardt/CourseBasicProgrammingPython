...
result = [random.choice(shopping_list_dairy)] + [random.choice(shopping_list_fruit)] + [random.choice(shopping_list_sweets)]
print(result)
...
special_char = [":", ",", "$"]
if any(char in special_char for char in file_name):
