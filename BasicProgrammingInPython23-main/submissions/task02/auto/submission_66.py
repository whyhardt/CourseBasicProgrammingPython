...
b = None
string_a = input(a)
#print("String1: ", string_a)
string_b = input(b)
#print("String2: ", string_b)
...
n2 = len(file_name) - 2
n3 = len(file_name) - 1
ftype = file_name[n1] + file_name[n2] + file_name[n3]

if ftype == "txt" or "doc" or "pdf":
    file_type = "Document file"
    
elif ftype == "jpg" or "png":
    file_type = "Image file"
    
elif ftype == "mp4" or "mov":
