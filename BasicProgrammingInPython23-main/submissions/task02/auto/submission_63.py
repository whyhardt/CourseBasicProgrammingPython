...
programmer_joke = programmer_joke.splitlines()
...
shopping_list = ["Apple", "Banana", "Cherry", "Tomato", "Potato", "Onion"]
first_elem= shopping_list[:2]
last_elem= shopping_list[-2:]
...
result = [shopping_list_dairy[1]] + [shopping_list_fruit[2]] + [shopping_list_sweets[-1]]
print(result)
...
if  file_type== ".txt" or file_type== ".doc" or file_type== ".pdf":
