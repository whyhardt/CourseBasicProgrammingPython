...
string_a = input("strring_a: ")
string_b = input("strring_b: ")
...
result = shopping_list_dairy[0:1]+shopping_list_fruit[2:-2]+[shopping_list_sweets[2]]
print(result)
...
if file_name.endswith(".txt") or file_name.endswith(".pdf") or  file_name.endswith(".doc"):
