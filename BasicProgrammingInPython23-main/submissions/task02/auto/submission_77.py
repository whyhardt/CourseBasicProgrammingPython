...
# **Your university mail**: lotmueller@uos
# ___
# 
...
list_of_symbols=[',',':','.','%','&','$']
for i in file_name:
    if list_of_symbols.__contains__(i):
        print(i)
for i in file_name:
    if list_of_symbols.__contains__(i):
        print(file_name.replace(i, '_'))
...
if file_name[-3:]=='txt' of file_name[-3:]=='doc' or file_name[-3:]=='pdf':
