...
string_a = input(str("write a string:"))
string_b =  input(str("write a string:"))
...
result = shopping_list[2] #niyazi nist index ro benevisi tuye list
print(result)
...
result = shopping_list[0:2] #avalin adad yani value,adad dovomi ro injuri minevisim un index morede nazar +1 = value morede nazar
print(result)
...
shopping_list = ["Apple", "Banana", "Cherry", "Tomato", "Potato", "Onion"]
shopping_list2 = shopping_list[0:2]
shopping_list3 = shopping_list[-2: len(shopping_list)]
result = shopping_list2 + shopping_list3
print(result)
...
shopping_list = ["Apple", "Banana", "Cherry", "Tomato", "Potato", "Onion"]
result = shopping_list[0:len(shopping_list):2]
print(result)
...
elif ".txt" in file_name or ".doc" in file_name or ".pdf" in file_name:
