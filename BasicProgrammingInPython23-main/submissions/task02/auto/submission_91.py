...
string_a = input("Give me an input")
string_b = input("Give me another input")
...
result = [shopping_list_fruit[0]] + [shopping_list_dairy[1]] + [shopping_list_sweets[2]]
print(result)
...
file_types = {(".txt", ".doc", ".pdf"): "Document file", (".jpg", ".png"): "Image file", (".mp4", ".mov"): "Video file"}
...
for extension, file_format in file_types.items():
    if file_extension in extension:
        file_type = file_format
        break
print("'", file_extension, "'" " is a ", file_type)
