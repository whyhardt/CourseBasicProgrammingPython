...
if file_name[file_name.index("."):] == ".txt" or file_name[file_name.index("."):] == ".doc" or file_name[file_name.index("."):] == ".pdf":
    file_type = "Document file"
    
elif file_name[file_name.index("."):] == ".jpg" or file_name[file_name.index("."):] == ".png" :
    file_type = "Image file"
    
elif file_name[file_name.index("."):] == ".mp4" or file_name[file_name.index("."):] == ".mov" :
