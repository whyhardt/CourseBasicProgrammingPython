...
string_a = input("Please insert a word or sentence: ")
string_b = input("Please insert a word or sentence: ")
...
result = [shopping_list_fruit[3]] + [shopping_list_dairy[1]] + [shopping_list_sweets[0]]
print(result)
...
if file_name[-3:] in ["txt" or "doc" or "pdf"]:
