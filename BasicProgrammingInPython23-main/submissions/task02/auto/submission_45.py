...
programmer_joke = str.split(programmer_joke)  # str.splitlines would work as well
...
string_a = input("Give your first input")
string_b = input("Give your second input")
...
# result = shopping_list.index("Cherry")
...
else: print("No special characters")
...
if  file_name.endswith((".txt", ".doc",".pdf")) == True :
    file_type = "Document file"
    

elif file_name.endswith((".jpg",".png")) == True:
    file_type = "Image file"
    
elif file_name.endswith((".mp4",".mov")) == True:
