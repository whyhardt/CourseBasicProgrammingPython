...
result = [shopping_list_fruit[0]] + [shopping_list_dairy[1]] + [shopping_list_sweets[-1]]
print(result)
...
if ".txt" or ".doc" or ".pdf" in file_name:
    file_type = "Document file"
    
elif ".jpg" or ".png" in file_name:
    file_type = "Image file"
    
elif ".mp4" or ".mov" in file_name:
