...
# **Your name here**: Luca Yella Bialek  
# **Your university mail**: lbialek@uni-osnabrueck.de
# 
# ___
# 
...
max_index = np.argmax(arr_reshaped)
...
# Create a 1D array of 100 random values
arr1 = np.random.randint(100)

# Split the array into positive and negative elements
positive_array = arr[arr1 < 0]
negative_array = arr[arr1 >= 0]
...
sdr = positive_array / negative_array
