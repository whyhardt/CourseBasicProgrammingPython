...
# **Your university mail**: sscheerhorn@uni-osnabruecck.de
# 
# ___
# 
...
index = 0
sum_to_index = 0
while sum_to_index < threshold:
    sum_to_index = sum_to_index + arr[index]
    #print ("sum to index", index,"is:", sum_to_index)
    index = index + 1
index = index -1
