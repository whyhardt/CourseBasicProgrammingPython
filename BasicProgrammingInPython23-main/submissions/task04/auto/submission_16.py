...
def get_sum(a,b,c,d):
    sumall = a+b+c+d
    return("the sum of all 4 numbers is:",sumall)
...
def remove_vowels(my_str):
    ...
    for i in range(0,len(my_str)):
        my_str[i]
        my_new_stra = my_str.replace('a','')
        my_new_strA = my_new_stra.replace('A','')
        my_new_stre = my_new_strA.replace('e','')
        my_new_strE = my_new_stre.replace('E','')
        my_new_stri = my_new_strE.replace('i','')
        my_new_strI = my_new_stri.replace('I','')
        my_new_stro = my_new_strI.replace('o','')
        my_new_strO = my_new_stro.replace('O','')
        my_new_stru = my_new_strO.replace('u','')
        my_new_strU = my_new_stru.replace('U','')
        
        
    
    return my_new_strU

#lowercase letters und uppercase letters von a,e,i,o,u
