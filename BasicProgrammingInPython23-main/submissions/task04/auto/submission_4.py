...
def intersection(list_a, list_b):
    return list_a.intersection(list_b)


# In[14]:


# NOTE that a set approach is used here, so the lists are converted to sets by using the {} brackets
list_a = {1, 2, 3, 4, 5}
list_b = {3, 4, 5, 6, 7}
...
# I am going to re-use my code from task 3 here
def remove_vowels(string):
    ...
    print("The found vowels are:", ' '.join(found_vowels))
    print("Here's the output string with the vowels removed:", ''.join(non_vowels))
...
# Reference: Code adapted from https://www.geeksforgeeks.org/python-program-for-program-for-fibonacci-numbers-2/, using memoization technique
