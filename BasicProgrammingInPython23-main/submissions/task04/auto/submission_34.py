...
def is_prime(a):
    if a == 2:
        ...
        return "The number you put in has to be greater than 1. Please run the cell again and choose another input." 
    else:
        for i in range(2, a):
            if a % i == 0:
                return False
...
def fibonacci(n):
    #if n < 0:
      #  return "not possible to calculate as your input is smaller than 0. Please run the cell again and choose another input."
    if n == 0 or n == 1:
        return n
    #else:
