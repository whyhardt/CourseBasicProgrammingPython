...
print(f'Sum of {a}, {b}, {c} and {d} is {get_sum(a, b, c, d)}')
...
print(f'The area from a circle is {circle_area(r)}')
...
list_a = input("Enter numbers for a first list: ").split()
list_b = input("Enter numbers for a second list: ").split()              
