...
def get_sum(number_1:[float,int],number_2:[float,int],number_3:[float,int],number_4:[float,int]) -> [float,int]:
    ''' Takes 4 numbers and returns the sum '''
    my_sum = number_1 + number_2 + number_3 + number_4
    return my_sum
...
def circle_area(radius:[float,int],x = pi)-> [float,int]:
