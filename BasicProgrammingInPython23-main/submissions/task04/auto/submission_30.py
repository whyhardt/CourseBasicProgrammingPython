...
# **Your name here**: Victoria Wiliams  
...
#is not running. It says "math is not defined" and I don´t know how to fix it.
...
# ### Calculating the nth Fibonacci Number Using Recursion (2/6 points)
# The Fibonacci sequence is a series of numbers in which each number is the sum of the two preceding ones. In this question, we will focus on calculating the nth Fibonacci number using recursion. Write a recursive function **fibonancci** that takes an input **n** and returns the nth Fibonacci number. Assume that the Fibonacci sequence starts with 0 as the 1st number and 1 as the 2nd number.   
...
# 
# **Hint:** Remember to cover both the recursive case and the base case, else you end up with an infinite loop. It may even help a lot to start writing by separting into these two cases in the function.
...
# ### Greatest common divisor (4/6 points)
