...
# **Your name here**: Luca Bialek  
# **Your university mail**: lbialek@gmail.com
# 
# ___
# 
...
for i in range(num_cities):
    ...
    city_populatin = input("Enter the Population f the city: ")

    cities.append(city_name, city_populatin)
...
def symmetric_difference(set1, set2):
  return set.symmetric_difference(set1, set2)
...
def display_all_books(collection):
    for book_id in collection:
        book = collection[book_id]
        print("ID:", book_id, "Title:", book['title'], "Author:", book['author'], "Year:", book['year'])
...
class StudentGradeTracker:
    ...
    def add_grade(self, student_id, grade):
       if student_id in self.student_grades:
           ...
           print("Grade for student {student_id} has been updated.")

    def remove_grade(self, student_id):
         if student_id in self.student_grades:
             del self.student_grades[student_id]
             print("Grade for student {student_id} has been deleted")
         else:
             print("Student {student_id} does not have a grade recorded.")

    def display_grades(self):
        if self.student_grades != 0:
            for student_id, gades in self.student_grades:
