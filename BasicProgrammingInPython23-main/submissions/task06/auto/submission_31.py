...
# **Your university mail**: mbakhshandeh@uos.de
# 
# ___
# 
...
for i in range(num_cities):
    cities.append( (input("Enter the name of city: "), int(input("Enter the population of city: "))) )

    
# Calculate the total population
total_population = sum(population for name, population in cities)
...
def search_book(collection, book_id):
    ...
    else: print("No book is available by this name.")
