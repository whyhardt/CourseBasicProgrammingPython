...
for i in range(num_cities):
    city_name = input(f"Enter the name of city: ")
...
set1_elements = input("Enter elements for set1 (separated by spaces): ")
set1 = set(set1_elements)

set2_elements = input("Enter elements for set2 (separated by spaces): ")
...
def remove_book(collection, book_id):
    if book_id in collection:
        ...
        print("Book ID not found in the collection.")
