...
def calculate_average(student_grades):
    ...
    for x in range(1,len(student_grades)):
       
        average+= student_grades[x]
    
    return average / (len(student_grades) -1)
...
class StudentGradeTracker:
    ...
    def add_grade(self, student_id, grade):
        ...
        if student_id in self.student_dict:
            ...
            self.student_dict.update({student_id: grade})
        else:
            self.student_dict.update({student_id: grade})
    ...
    def remove_grade(self, student_id):
        ...
        if student_id in self.student_dict:
            ...
            print("Studnet does not have a grade recorded")

    def display_grades(self):

        if bool(self.student_dict) == False:
            print("No grades have been recorded")
        else:
            for x in self.student_dict:

                print(x, ":",self.student_dict[x])
