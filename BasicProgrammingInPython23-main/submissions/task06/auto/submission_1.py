...
for i in range(num_cities):
    # Get the name & population
    city_name = input("Enter the name of the city: ")
    city_population = int(input("Enter the population of the city: "))    
    
    # Append the city population tuple to the list of cities
...
def calculate_average(grades):
    # Average grade is the sum of grades devided by thenumber of subjects 
...
for student_grades in grades:
    name = student_grades[0]  # get student name from tuple
    grades = student_grades[1:]  # get grade from tuple
...
def add_book(collection, book_id, title, author, year):
    book_specificities = {"title": title, "author": author, "year": year}
    # Add to collection
    collection[book_id] = book_specificities
...
def search_book(collection, book_id):
    if book_id in collection:
        book_specificities = collection[book_id]
        # show specificities
        print("Title:", book_specificities["title"])
        print("Author:", book_specificities["author"])
        print("Year:", book_specificities["year"])
    else:
        print("Unfortunately, this book is not in our collection.")
        

def display_all_books(collection):
    # show specificities of all books in the collection
    for book_id, book_spefificities in collection.items():
...
class StudentGradeTracker:
    ...
    def add_grade(self, student_id, grade):
        if student_id in self.grades:
            print("Grade has been updated for Student ID:", student_id)
    ...
    def remove_grade(self, student_id):
        if student_id in self.grades:
            ...
            print("Grade removed for Student ID:", student_id)
        else:
            print("Student ID", student_id, "there is no grade recorded.")
    ...
    def display_grades(self):
        if self.grades:
            ...
            print("There has been no grade recorded.")
