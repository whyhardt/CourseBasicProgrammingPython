...
for i in range(num_cities):
    city_name = input("Enter the cities name: ")
    city_population = int(input("Enter the cities population: "))
...
set1 = set(input("Enter the elements of Set 1, separated by spaces: ").split())
set2 = set(input("Enter the elements of Set 2, separated by spaces: ").split())
...
class StudentGradeTracker:
    ...
    def remove_grade(self, student_id):
         if student_id in self.grade:
            self.grade.pop(student_id)
            print("Grade has been removed")

         else:
            print("There is no grade for the student")


    def display_grades(self):
        for student_id, grade in self.grade.items():
