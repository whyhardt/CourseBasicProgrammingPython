...
# **Your university mail**: ihovemann.person@uos.de
# 
# ___
# 
...
#cities = [("Emsdetten", 36000), ("Osnabrück", 160000), ("Berlin", 3645000000)]
...
def calculate_average(input_grades):
    summing = sum(input_grades[1:]) 
    lenght = len(input_grades[1:])
    return summing / lenght
...
set1 = set(input("enter the elements for set number 1").split())
set2 = set(input("enter the elements for set number 2").split())
