...
for i in range(num_cities):
    name = input(f"name of city: {i+1}")
    population = int(input(f"population of city: {i+1}"))
...
class StudentGradeTracker:
    ...
    def add_grade(self, student_id, grade):
        if student_id in self.grade_tracker:
            print(f"updated grade{student_id}.")
        self.grade_tracker[student_id] = int(grade)
        print(f"added grade {grade} for student ID {student_id}.")
    
    def remove_grade(self, student_id):
        if student_id in self.grade_tracker:
            del self.grade_tracker[student_id]
            print(f"grade removed {student_id}.")
        else:
            print(f"no grade recorded {student_id}.")
...
grade_tracker.add_grade("004", 88)
grade_tracker.add_grade("005", 96)
grade_tracker.add_grade("006", 79)
