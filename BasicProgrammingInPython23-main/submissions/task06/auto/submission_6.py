...
for i in range(num_cities):
    # Prompt the user for the name and population of each city
    city_name = input(f"Enter the name of city {i+1}: ")
    population = int(input(f"Enter the population of city {i+1}: "))
    # Append the city population tuple to the list
...
def calculate_average(anders):
    average = sum(anders) / len(anders)
    return average
