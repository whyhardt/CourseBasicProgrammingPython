...
for i in range(num_cities):
    my_list=[input("Enter the name of the city: "), int(input("Enter the population: "))]
...
total_population = 0
for i in cities:
    total_population = i[1]+total_population

# Find the city with the highest population

highest_city = cities[0]
for i in cities:
    if i[1] > highest_city[1]:
        highest_city = i


# Find the city with the lowest population
lowest_city = cities[0]
for i in cities:
    if i[1] < lowest_city[1]:
        lowest_city = i
...
set1={1, 2, 3, 4} 
set2={3, 4, 5, 6}
#set1=set(input("Enter set 1 separated by spaces: "))
#set1.remove(" ")
#set2=set(input("Enter set 2 separated by spaces: "))
#set2.remove(" ")
...
def symmetric_difference(set1, set2):
    ...
    set_symmetric_difference = set1_difference.union(set2_difference)
...
def add_book(collection, book_id, title, author, year):
    collection[book_id] = {'Author': author, 
                           'Title': title,
                            'Year': year}
    return collection
...
def remove_book(collection, book_id):
    return collection.pop(book_id)

def search_book(collection, book_id):
    if book_id in collection:
        return print(collection[book_id])
    else:
        return print("There is no book with id ", book_id, "in our collection")
...
class StudentGradeTracker:
    ...
    def add_grade(self, student_id, grade):
        if student_id in self.dictionary:
            self.dictionary.update({student_id: grade})
            print("The grade has been updated")
        else:
            self.dictionary[student_id] = grade

    def remove_grade(self, student_id):
        if student_id in self.dictionary:
            del self.dictionary[student_id]
            print("The grade has been removed")
        else:
            print("The student does not have a grade recorded")
    ...
    def display_grades(self):
        if self.dictionary:
            ...
            print("The grade tracker is empty")
...
#grade_tracker.remove_grade("001")
#grade_tracker.remove_grade("003")
