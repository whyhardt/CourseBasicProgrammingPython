...
for i in range(num_cities):
    # Get the city name and population from the user
    city_name = input(f"Enter the name of city #{i+1}: ")
    city_population = int(input(f"Enter the population of city #{i+1}: "))
    
    # Append the city name and population to the list as a tuple
