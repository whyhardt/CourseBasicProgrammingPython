...
for student_grades in grades:
    ...
    average_grade = calculate_average(student_grades[0:])
...
set1 = set(input("Enter your first set: ").split())
set2 = set(input("Enter your second set: ").split())
...
def remove_book(collection, book_id):
    if book_id in collection:
        ...
        print("This book got removed from your collection.")
    else:
...
class StudentGradeTracker:
    ...
    def remove_grade(self, student_id):
        if student_id in self.dict:
            ...
            print("This student has been removed from your collection.")
        else:
            print("Student not in collection")
