...
highest_city = max(cities, lambda x: x[0])

# Find the city with the lowest population
lowest_city = min(cities, lambda x: x[0])
...
set1 = set(input("Enter elements of the first set: "))
set2 = set(input("Enter elements of a second set: "))
...
class StudentGradeTracker:
    ...
    def display_grades(self):
        print("Grades: ")
        for student_id, grade in self.grade_tracker:
