...
for i in range(num_cities):
    ...
    pop = int(input(f"Enter the number of inhabitants of {city}: "))
...
def symmetric_difference(set1, set2):
  # Add implementation here
  # Remove pass after the implementation
    return set.union(set1.difference(set2),set2.difference(set1))

set1 = set(input("Enter the elements of set1 (separated by \",\"): ").split(','))
set2 = set(input("Enter the elements of set2 (separated by \",\"): ").split(','))
...
def add_book(collection, book_id, title, author, year):
    # Add implementation here
    # Remove pass after the implementation
    collection[book_id] = {"title": title, "author": author, "publication year": year}
...
def search_book(collection, book_id):
    # Add implementation here
    # Remove pass after the implementation
    if collection.get(book_id) != None:
        print(collection.get(book_id))
...
class StudentGradeTracker:
    ...
    def add_grade(self, student_id, grade):
        # Add implementation here
        # Remove pass after the implementation
        if student_id not in self.students_grades.keys():
            self.students_grades[student_id] = grade
        else:
            self.students_grades[student_id] = grade
            print(f"Student {student_id}'s grade has been updated.")
...
#             self.students_grades[student_id] = grade
            ...
            self.students_grades.pop(student_id)
            print(f"Student {student_id}'s grade has been removed.")

    def display_grades(self):
        # Add implementation here
        # Remove pass after the implementation
        if len(self.students_grades)>0:
            for k,v in self.students_grades.items():
                print(f"Student ID: {k}. Grade: {v}.")
        else:
...
# grade_tracker.add_grade("002", 91)
