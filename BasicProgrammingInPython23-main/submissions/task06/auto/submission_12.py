...
# Create an empty book collection dictionary
book_collection = {}

# Add books to the collection
add_book(book_collection, 1, "To Kill a Mockingbird", "Harper Lee", 1960)
add_book(book_collection, 2, "1984", "George Orwell", 1949)
add_book(book_collection, 3, "The Great Gatsby", "F. Scott Fitzgerald", 1925)

# Display the collection
display_collection(book_collection)
