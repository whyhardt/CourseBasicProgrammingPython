...
# **Your name here**: Claudius Trebing   
# **Your university mail**: ctrebing@uos.de
# 
# ___
# 
...
for i in range(num_cities):
    # Get the name and population of each city from the user
    name = input("Enter the name of the city: ")
    population = int(input("Enter the population of the city: "))
    
    # Append the city and its population as a tuple to the cities list
    cities.append((name, population))

total_population = 0
for city in cities:
    # Add the population of each city to the total population
...
def calculate_average(student_grades_tuple):
    average_grade = student_grades_tuple[1]+student_grades_tuple[2]+student_grades_tuple[3]+student_grades_tuple[4]
...
def count_unique_elements(lst):
  set1 = set(lst)
  converted_list = list(set1)
  unique_numbers = len(converted_list)
