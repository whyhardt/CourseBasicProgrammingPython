...
# **Your university mail**: srebers@uni-osnabrueck.de
# 
# ___
# 
...
cities = []
#cities = [("Berlin", 3664088), ("London", 7421209), ("Paris", 2220445)]
...
def calculate_average(grades):
  return sum(grades[i] for i in [1,2,3,4]) / 4
...
class StudentGradeTracker:
    def __init__(self):
        self.grade_dictonary = {}

    def add_grade(self, student_id, grade):
        if student_id in self.grade_dictonary:
            print("grade has been updated")
        self.grade_dictonary[student_id] = grade

    def remove_grade(self, student_id):
        if not student_id in self.grade_dictonary:
            print("the student does not have a grade recorded")
        elif self.grade_dictonary[student_id] == "removed":
                print("grade has been removed")
        else:
            self.grade_dictonary[student_id] = "removed"

    def display_grades(self):
        if not self.grade_dictonary:
            print("no grades have been recorded")
        else:
            for i in self.grade_dictonary:
                print("Student ID:", i, "Grade:", self.grade_dictonary[i])
