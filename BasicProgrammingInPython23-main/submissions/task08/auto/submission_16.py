...
# Scatter plot
plt.scatter(weekdays, alice_steps, marker='o', c='red', label='Alice', linestyle="dotted")
...
plt.plot(weekdays, alice_steps, c='red')
plt.plot(weekdays, bob_steps, c='blue')
plt.plot(weekdays, carol_steps, c='green')
...
plt.bar(regions, revenue[:, 2], bottom=np.sum(revenue[:, :2], axis=1), color='blue', label=categories[2])
