...
fig.legend(["Student 1", "Student 2"], loc="lower right")
...
plt.bar(regions, revenue[:,0], label=categories[0])
plt.bar(regions, revenue[:,1], label=categories[1], bottom=revenue[:,0])
plt.bar(regions, revenue[:,2], label=categories[2], bottom=revenue[:,0]+revenue[:,1])
