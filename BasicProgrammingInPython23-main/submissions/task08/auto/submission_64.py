...
plt.plot(weekdays, alice_steps, color = 'red', ls = '-', lw = 2)
plt.plot(weekdays, bob_steps, color = 'blue', ls = ':', lw = 2 )
plt.plot(weekdays, carol_steps, color = 'green', ls = '--', lw = 2)

# Legend
plt.legend()

# Axes labels and title
plt.title("Steps taken by students")
plt.xlabel("Days of the week")
...
plt.bar(regions, y1, color = 'red', label = 'Electronics')
plt.bar(regions,y2, bottom = y1, color = 'green', label = 'Clothing' )
plt.bar(regions, y3, bottom = y1+y2, color = 'blue', label = 'Books' )
