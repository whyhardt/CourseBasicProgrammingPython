...
# **Your name here**: Yannik Schneider  
# **Your university mail**: yschneider@uos.de
# 
# ___
# 
...
plt.plot(weekdays, alice_steps, color='red', linestyle='-', linewidth=2)
plt.plot(weekdays, bob_steps, color='blue', linestyle='-', linewidth=2)
plt.plot(weekdays, carol_steps, color='green', linestyle='-', linewidth=2)
...
plt.bar(regions, revenue[:, 1], color='green', label='Clothing', bottom=revenue[:, 0])
plt.bar(regions, revenue[:, 2], color='blue', label='Books', bottom=revenue[:, 0] + revenue[:, 1])
