...
plt.plot(days, temperature, color='purple')#includes the variables and defines the color of the plot
plt.title("Weekly Temperature")#naming the plot
plt.xlabel("Days of the Week")#labeling the x-axis
...
plt.bar(regions, revenue[:, 2], bottom=revenue[:, 0] + revenue[:, 1], color='blue')
