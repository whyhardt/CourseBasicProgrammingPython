...
plt.plot(weekdays, bob_steps, linestyle='dotted', color='blue')
...
plt.title('Steps Taken Analysis')
...
fig.legend(['First Student', 'Second Student'], loc = "lower left")
...
v1 = [revenue[0][0],revenue[1][0],revenue[2][0],revenue[3][0]]
v2 = [revenue[0][1],revenue[1][1],revenue[2][1],revenue[3][1]]
v3 = [revenue[0][2],revenue[1][2],revenue[2][2],revenue[3][2]]
      
    
plt.bar(regions,v1,color= "red")
plt.bar(regions,v2,bottom=v1, color= "green")
plt.bar(regions,v3,bottom=np.add(v1,v2), color= "blue")

plt.title("Sales Revenue by Region and Product Category")
plt.xlabel("Regions")
plt.ylabel("Revenue")
plt.legend(['Electronics', 'Clothing', 'Books'], loc = "lower left")
