...
plt.plot(days, temperature, color = 'tab:purple')
...
plt.plot(weekdays, alice_steps, ls = ':', color ='gray', lw = '2')
plt.plot(weekdays, bob_steps, ls = '--', color ='olive', lw = '5')
plt.plot(weekdays, carol_steps, ls = '-.', color ='tab:purple', lw = '8')

# Legend
plt.legend(["Alice", "Bob", "Carol"])

# Axes labels and title
plt.title("Steps taken by Alice, Bob and Carol on Weekdays")
plt.xlabel("Weekdays")
...
#print(student2_scores)
# Set the bin sizes for the histograms
bin_size_student1 = 1
bin_size_student2 = 1

# Create a figure with two subplots
fig, axes = plt.subplots(1, 2, width_ratios=(10, 4))
...
fig.legend(["Student1" , "Student2"], loc = 7)

# Adjust spacing between subplots
fig.tight_layout(pad = 0.1 , w_pad = 7.5 )
...
plt.bar(regions , np.array([ revenue[0][0], revenue[1][0], revenue[2][0], revenue[3][0] ]) , color = 'red')
plt.bar(regions , np.array([ revenue[0][1], revenue[1][1], revenue[2][1], revenue[3][1] ]) , bottom = np.array([ revenue[0][0], revenue[1][0], revenue[2][0], revenue[3][0] ]) ,  color = 'green')
plt.bar(regions , np.array([ revenue[0][2], revenue[1][2], revenue[2][2], revenue[3][2] ]) , bottom = np.array([ revenue[0][0], revenue[1][0], revenue[2][0], revenue[3][0] ]) + np.array([ revenue[0][1], revenue[1][1], revenue[2][1], revenue[3][1] ]), color = 'blue')

plt.title("Sales Revenue by Region and Product Category")
plt.xlabel("Regions")
plt.ylabel("Revenue")
plt.legend(["Electronics" , "Clothing" , "Books"])
