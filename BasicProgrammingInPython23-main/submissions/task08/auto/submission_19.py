...
plt.plot(weekdays, alice_steps, color='red',linewidth=2.0)
plt.plot(weekdays, bob_steps, color='blue',linewidth=2.0)
plt.plot(weekdays, carol_steps, color='green',linewidth=2.0)
...
bin_size_student1 = 5
bin_size_student2 = 4 #half of the standard deviation
...
axes[0].set_xlabel("Student 1 Math Exam Score Distribution")
...
plt.bar(regions, revenue[:, 0], color='red', edgecolor='black', label=categories[0])
plt.bar(regions, revenue[:, 1], color='green', edgecolor='black', bottom=revenue[:, 0], label=categories[1])
plt.bar(regions, revenue[:, 2], color='blue', edgecolor='black', bottom=revenue[:, 0]+revenue[:, 1], label=categories[2])
