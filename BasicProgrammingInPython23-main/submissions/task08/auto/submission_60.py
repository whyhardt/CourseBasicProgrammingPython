...
plt.plot(days, temperature, c = 'purple')
...
plt.plot(weekdays, alice_steps, c='red', ls=':', lw='3')
plt.plot(weekdays, bob_steps, c='blue', ls='-.', lw='2')
plt.plot(weekdays, carol_steps, c='green', ls='--', lw='2.5')
...
fig.legend(["Student 1", "Student 2"], loc = "lower center")
...
# Transpose revenue to fit to categories
trans_revenue = revenue.transpose()

# Create the bar plots and stack them by setting their bottom to the current heigth of the plot
plt.bar(regions, trans_revenue[0], color = 'red', label = categories[0])
plt.bar(regions, trans_revenue[1], bottom = trans_revenue[0], color = "green", label = categories[1])
plt.bar(regions, trans_revenue[2], bottom = trans_revenue[0] + trans_revenue[1], color = "blue", label = categories[2])
