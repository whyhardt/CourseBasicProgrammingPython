...
plt.plot(weekdays,alice_steps, c='r')
plt.plot(weekdays,bob_steps, c='b')
plt.plot(weekdays,carol_steps, c='g')
...
fig.legend(["Student 1","Student 2"], loc='upper right', bbox_to_anchor=(0.98, 0.9))
