...
plt.plot(weekdays, alice_steps, '.r:')
plt.plot(weekdays, bob_steps, '.b:')
plt.plot(weekdays, carol_steps, '.g:')
...
bin_size_student1 = 10
bin_size_student2 = 10
...
fig.legend(['First Sudent', 'Second Student'], loc = "upper center")
...
plt.bar(regions, revenue[:,0],bottom=revenue[:,0] + revenue[:,1], color='b')
