...
plt.plot(weekdays, alice_steps, color='red', linewidth=1, linestyle='-')
plt.plot(weekdays, bob_steps, color='blue', linewidth=1, linestyle='-')
plt.plot(weekdays, carol_steps, color='green', linewidth=1, linestyle='-')

# Legend
plt.legend(loc='best')

# Axes labels and title
plt.title('Steps Taken Each Day of the Week')
plt.xlabel('Weekdays')
...
plt.bar(regions, revenue[:,1], color='green', label=categories[1])
plt.bar(regions, revenue[:,2], color='blue', label=categories[2])
