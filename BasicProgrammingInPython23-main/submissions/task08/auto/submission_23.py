...
plt.plot(weekdays, alice_steps,color='red', ls='-')
plt.plot(weekdays, bob_steps,color='blue', ls='-')
plt.plot(weekdays, carol_steps,color='green', ls='-')
...
plt.bar(regions, revenue[:,1], color = "green")
plt.bar(regions, revenue[:,2], color = "blue")

plt.title("Sales Revenue by Region and Product Category")
plt.xlabel("Regions")
plt.ylabel("Revenue")

legend_labels = ["Electronics", "Clothing", "Books"]
