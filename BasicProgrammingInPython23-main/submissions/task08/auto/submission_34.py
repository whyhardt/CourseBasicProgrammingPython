...
# Scatter plot
plt.scatter(weekdays, alice_steps, marker ='o', color ='#ff859b', label ='Alice')
plt.scatter(weekdays, bob_steps, marker ='s', color ='#b274ff', label ='Bob')
plt.scatter(weekdays, carol_steps, marker ='^', color ='#91ffff', label ='Carol')

# Line connecting scatterplot points
plt.plot(weekdays, alice_steps, color = '#ff859b')
plt.plot(weekdays, bob_steps, color = '#b274ff')
plt.plot(weekdays, carol_steps, color = '#91ffff')

# Legend
plt.legend()

# Axes labels and title
plt.title("Steps in 5 Days", color = '#66d37b')
plt.xlabel("Days", color = '#913c7b')
plt.ylabel("Number of steps", color = '#913c7b')
...
bin_size_student1 = 5 # Your code here
bin_size_student2 = 5 # Your code here

# Create a figure with two subplots
fig, axes = plt.subplots(1, 2, figsize =(10, 4))

# Plot histogram for Student 1
axes[0].hist(student1_scores, bins=range(50, 101, bin_size_student1), color='#ff859b', alpha=0.7)
axes[0].set_title("Student 1 Math Exam Score Distribution")
axes[0].set_xlabel("Scores")
axes[0].set_ylabel("Frequency")

# Plot histogram for Student 2
axes[1].hist(student2_scores, bins=range(50, 101, bin_size_student2), color='#91ffff', alpha=0.7)
...
plt.bar(regions, revenue[:, 0], label = 'Electronics', color='#ff859b')
plt.bar(regions, revenue[:, 1], bottom = revenue[:, 0], label = 'Clothing', color='#91ffff')
plt.bar(regions, revenue[:, 1], bottom = revenue[:, 0] + revenue[:, 1], label = 'Books')
