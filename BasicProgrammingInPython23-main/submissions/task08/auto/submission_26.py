...
plt.plot(weekdays,alice_steps,ls = 'dotted', c = 'r', lw = 3)
plt.plot(weekdays,bob_steps,ls = 'dashed', c = 'b', lw = 2)
plt.plot(weekdays,carol_steps,ls = 'dashdot', c = 'g', lw = 2)
...
plt.bar(regions,[revenue[i][0] for i in [0,1,2,3]],color='r',label="Electronics")
plt.bar(regions,[revenue[i][1] for i in [0,1,2,3]],color='g',bottom=[revenue[i][0] for i in [0,1,2,3]],label="Clothing")
plt.bar(regions,[revenue[i][2] for i in [0,1,2,3]],color='b',bottom=[revenue[i][0]+revenue[i][1] for i in [0,1,2,3]],label="Books")
