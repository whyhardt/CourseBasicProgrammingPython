...
temperature = np.random.randint(20, 30, 7, dtype=int)


plt.plot(days, temperature, '-s', color='tab:purple')
...
plt.plot(weekdays, bob_steps, color='blue', linestyle= '--', linewidth= 2)
...
plt.title("Student Steps Comparison")
...
student1_scores = np.random.normal(70, 10, 100)
student2_scores = np.random.normal(80, 8, 100)
