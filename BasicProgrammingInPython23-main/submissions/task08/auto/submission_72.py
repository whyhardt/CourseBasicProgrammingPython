...
plt.plot(weekdays, alice_steps, linestyle="-", color="red")
plt.plot(weekdays, bob_steps, linestyle="-", color="blue")
plt.plot(weekdays, carol_steps, linestyle="-", color="green")

# Legend
plt.legend()

# Axes labels and title
plt.xlabel("Weekdays", loc="left", color="Orange", size=12)
plt.ylabel("Number of steps", color="purple", size=12)
plt.title("Weekly Steps Taken", size=18)
...
fig.legend(["Student 1", "Student 2"], loc="center right", fontsize="small")
...
plt.bar(regions, revenue[0:, 0], color="red", label=categories[0])
plt.bar(regions, revenue[0:, 1], bottom=revenue[0:, 0], color="green", label=categories[1])
plt.bar(regions, revenue[0:, 2], bottom=revenue[0:, 0] + revenue[0:, 1], color="blue", label=categories[2])
