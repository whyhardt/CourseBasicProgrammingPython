...
# create seven integers for the days of the week
...
plt.plot(weekdays, alice_steps, linestyle = 'dashed', color = 'red', linewidth = 1)
plt.plot(weekdays, bob_steps, linestyle = 'dashdot', color = 'blue', linewidth = 2)
plt.plot(weekdays, carol_steps, linestyle = 'dotted', color = 'green', linewidth = 3)
...
plt.title('Steps Taken Analysis', color = 'darkgreen')
...
axes[1].set_title("Student 2 Math Exam Score Distribution") # Your code here
axes[1].set_xlabel("Scores") # Your code here
axes[1].set_ylabel("Frequency") # Your code here

# Add a legend to differentiate the two students
fig.legend(['Student 1', 'Student 2'], loc = 'center')
...
electronics = revenue[:,[0]].flatten()
clothes = revenue[:,[1]].flatten()
books = revenue[:,[2]].flatten()

plt.bar(regions, electronics, color = 'red')
plt.bar(regions, clothes, bottom = electronics, color = 'green')
plt.bar(regions, books, bottom = electronics+clothes, color = 'blue')

plt.title("Sales Revenue by Region and Product Category")
plt.xlabel('Regions')
plt.ylabel('Revenue')
plt.legend(['Electronics', 'CLothes', 'Books'])
