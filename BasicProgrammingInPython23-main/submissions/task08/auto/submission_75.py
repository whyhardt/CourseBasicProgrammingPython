...
plt.plot(weekdays,alice_steps, color='red', linewidth=2)
plt.plot(weekdays, bob_steps, color='blue', linewidth=2)
plt.plot(weekdays, carol_steps, color='green', linewidth=2)

# Legend
plt.legend()

# Axes labels and title
plt.title("Steps Taken Per Day In A Week")
plt.xlabel("Days of the Week")
...
# swap axes
revenue= np.swapaxes(revenue, 0,1)

plt.bar(regions, revenue[0], label = categories[0], color = 'red')
plt.bar(regions, revenue[1], bottom = revenue[0], label = categories[1], color = "green")
plt.bar(regions, revenue[2], bottom = revenue[0]+revenue[1], label = categories[2], color = "blue")
