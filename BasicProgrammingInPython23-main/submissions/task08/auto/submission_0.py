...
plt.plot(weekdays, alice_steps, color = "red", linewidth =0.5, linestyle="--")
plt.plot(weekdays, bob_steps, color= "blue", linewidth =0.5, linestyle="--")
plt.plot(weekdays, carol_steps, linewidth =0.5, linestyle="--")
# Legend
plt.legend()
...
plt.xlabel("Weekdays")
plt.ylabel("steps")
plt.title("Steps per Person per Day")
...
plt.bar(regions, revenue[2], bottom= np.add(revenue[0], revenue[1]), color = "blue", label = "Books")
