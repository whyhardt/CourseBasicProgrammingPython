...
plt.plot(days, temperature, "purple")
...
# Scatter plot
plt.scatter(weekdays, alice_steps, marker='o', c='red', data='Alice')
plt.scatter(weekdays, bob_steps, marker='s', c='blue', data='Bob')
plt.scatter(weekdays, carol_steps, marker='^', c='green', data='Carol')

# Line connecting scatterplot points
plt.plot(weekdays, alice_steps, "red")
plt.plot(weekdays, bob_steps, "blue")
plt.plot(weekdays, carol_steps, "green")

# Legend
plt.legend(["Alice", "Bob", "Carol"], bbox_to_anchor=(1.2, 1))
...
bin_size_student1 = 21
bin_size_student2 = 17
...
fig.legend(["Student 1", "Student 2"], bbox_to_anchor=(1.15, 1))
...
for x in range(revenue.shape[0]):
    electronics_revenue.append(revenue[x, 0])
    clothing_revenue.append(revenue[x, 1])
    books_revenue.append(revenue[x, 2])

plt.bar(regions, electronics_revenue, color="red")
plt.bar(regions, clothing_revenue, color="green")
plt.bar(regions, books_revenue, color="blue")

plt.title("Sales Revenue by Region and Product Category")
plt.xlabel("Regions")
plt.ylabel("Revenue")
plt.legend(["Electronics", "Clothing", "Books"],  bbox_to_anchor=(1, 1))
