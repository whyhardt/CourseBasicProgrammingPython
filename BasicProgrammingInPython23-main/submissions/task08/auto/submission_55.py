...
temperature = [random.randint(20,30) for _ in range(7)]
...
plt.plot(weekdays, alice_steps, color = 'red', linestyle = '--',lw=2)
plt.plot(weekdays, bob_steps, color = 'blue', linestyle = ':',lw=2)
plt.plot(weekdays, carol_steps, color = 'green', linestyle = '-',lw=2)
# Legend
...
plt.xlabel('Days of the week')
plt.title('Steps taken throughout the week by Alice, Bob and Carol')
...
#I'm not sure what should I put in legend, since the histograms are already named as Student 1 and Student 2
