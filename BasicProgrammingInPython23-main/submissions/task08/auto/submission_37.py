...
# Scatter plot
plt.scatter(weekdays, alice_steps, linestyle =  "-", marker='o', color='red', label='Alice')
...
plt.plot(weekdays, alice_steps, linestyle =  "-", marker='o', color='red')
plt.plot(weekdays, bob_steps, marker='s', color='blue')
plt.plot(weekdays, carol_steps, marker='^', color='green')
...
plt.xlabel("weekdays")
plt.ylabel("steps")
plt.title("steps taken on weekdays")
...
plt.bar(regions, revenue[:, 0], 0.5, bottom = 0)
plt.bar(regions, revenue[:, 1], 0.5, bottom = revenue[:, 0])
plt.bar(regions, revenue[:, 2], 0.5, bottom = revenue[:, 1] + revenue[:, 0])
