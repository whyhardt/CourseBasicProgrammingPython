...
# Scatter plot
plt.scatter(weekdays, alice_steps, marker ='o', color ='red', cmap ='Alice')
plt.scatter(weekdays, bob_steps, marker ='s', color ='blue', cmap ='Bob')
plt.scatter(weekdays, carol_steps, marker ='^', color ='green', cmap ='Carol')

# Line connecting scatterplot points
plt.plot(weekdays, alice_steps, color = "red", linewidth = 1)
plt.plot(weekdays, bob_steps, color = "blue", linewidth = 1)
plt.plot(weekdays, carol_steps, color = "green", linewidth = 1)

# Legend
plt.legend(["Alice", "Bob", "Carol"], loc = "upper left")

# Axes labels and title
plt.xlabel("Weekdays", size = 15)
plt.ylabel("Number of Steps", size = 15)
plt.title("Steps in one Week", size = 20)
...
plt.bar(regions, revenue[:,1], bottom = revenue[:,0], color = "g")
plt.bar(regions, revenue[:,2], bottom = revenue[:,0]+ revenue[:,1], color = "b")
