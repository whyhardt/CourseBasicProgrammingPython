...
# **Your university mail**: sara.guenther@web.de
# 
# ___
# 
...
# Scatter plot
plt.scatter(weekdays, alice_steps, marker='o', edgecolors='red', label='Alice')
plt.scatter(weekdays, bob_steps, marker='s', edgecolors='blue', label='Bob')
plt.scatter(weekdays, carol_steps, marker='^', edgecolors='green', label='Carol')

# Line connecting scatterplot points
plt.plot(weekdays, alice_steps, ls="-")
plt.plot(weekdays, bob_steps, ls="-")
plt.plot(weekdays, carol_steps, ls="-")

# Legend
plt.legend(['Alice', 'Bob', 'Carol'])

# Axes labels and title
plt.title("Steps taken through the week by Alice, Bob & Carol")
plt.xlabel("Days of the week")
plt.ylabel("Steps")
...
plt.bar(categories, revenue[0], color='red')
plt.bar(categories, revenue[1], bottom=revenue[0], color='green')
plt.bar(categories, revenue[2], bottom=revenue[0]+revenue[1], color='blue')
