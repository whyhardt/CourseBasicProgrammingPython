...
# Scatter plot
plt.scatter(weekdays, alice_steps, marker='o', c='red', cmap='Alice')
plt.scatter(weekdays, bob_steps, marker='s', c='blue', cmap='Bob')
plt.scatter(weekdays, carol_steps, marker='^', c='green', cmap='Carol')

# Line connecting scatterplot points
plt.plot(weekdays, alice_steps, color = "red", ls = "dotted")
plt.plot(weekdays, bob_steps, color = "blue", ls = "dashed")
plt.plot(weekdays, carol_steps, color = "green", ls = "dashdot")
...
plt.ylabel("Number of Steps", size = 15)
plt.title("Steps taken throughout the Week", size = 20)
