...
temperature =[random.uniform(20, 30) for _ in range(7)] # Your code here

plt.plot(days, temperatures, color='purple')
...
# Scatter plot
plt.___(weekdays, alice_steps, ____='o', ___='red', ___='Alice')
plt.___(weekdays, bob_steps, ___='s', ___='blue', ___='Bob')
plt.___(weekdays, carol_steps, ___='^', ___='green', ___='Carol')
...
student1_scores = np.random.normal(# Your code here, 100)  # Mean: 70, Standard Deviation: 10
student2_scores = np.random.normal(# Your code here, 100)   # Mean: 80, Standard Deviation: 8

# Set the bin sizes for the histograms
bin_size_student1 = # Your code here
bin_size_student2 = # Your code here
...
axes[0].set____("Student 1 Math Exam Score Distribution")
axes[0].set___("Scores")
axes[0].set___("Frequency")

# Plot histogram for Student 2
axes[1].hist(student2_scores, bins=range(50, 101, bin_size_student2), color='green', alpha=0.7)
axes[1].# Your code here
axes[1].# Your code here
axes[1].# Your code here
