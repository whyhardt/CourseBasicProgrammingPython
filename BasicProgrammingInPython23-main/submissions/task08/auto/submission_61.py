...
# Scatter plot
plt.plot(weekdays, alice_steps, marker='o', color='red', label='Alice',linestyle = "-")
plt.plot(weekdays, bob_steps, marker='s', color='blue', label='Bob',linestyle = "-")
plt.plot(weekdays, carol_steps, marker='^', color='green', label='Carol',linestyle = "-")
...
r1 = np.arange(len(revenue[0]))
r2 = [x + barWidth for x in r1]
r3 = [x + barWidth for x in r2]

plt.bar(r1, revenue[0], color='#7f6d5f', width=barWidth, edgecolor='white', label=categories[0])
plt.bar(r2, revenue[1], color='#557f2d', width=barWidth, edgecolor='white', label=categories[1])
plt.bar(r3, revenue[2], color='#2d7f5e', width=barWidth, edgecolor='white', label=categories[2])

plt.xticks([r + barWidth for r in range(len(revenue[:,0]))], regions)

plt.title("Sales Revenue by Region and Product Category")
plt.xlabel("product categories in regions")
plt.ylabel("revenue")
plt.legend()
