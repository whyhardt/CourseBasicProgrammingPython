...
temperature = list(random.randint(20, 30, (7)))

plt.plot(days, temperature, color = "purple")
plt.title("Weekly temmperature" )
plt.xlabel("\n Days of the Week")
...
# Scatter plot
plt.scatter(weekdays, alice_steps, marker='o', color='red')
plt.scatter(weekdays, bob_steps, marker='s', color='blue')
plt.scatter(weekdays, carol_steps, marker='^', color='green')

# Line connecting scatterplot points
plt.plot(weekdays, alice_steps,color='red', label='Alice')
plt.plot(weekdays, bob_steps,color='blue', label='Bob')
plt.plot(weekdays, carol_steps,color='green',label='Carol')

# Legend
plt.legend()

# Axes labels and title
plt.title("Students walking around")
plt.xlabel("\n Days of the week")
plt.ylabel("\n Steps taken")
# Display the plot
plt.show()
...
fig, axes = plt.subplots(1, 2, figsize=(10, 4))  #nth to be changed
...
fig.legend(['Student 1', 'Student 2'], bbox_to_anchor=(1.05, 1.05))
...
plt.bar(regions,revenue[0:4,0], color='red', label=categories[0])
plt.bar(regions,revenue[0:4,1],bottom=revenue[0:4,0], color='green', label=categories[1])
plt.bar(regions,revenue[0:4,2],bottom=revenue[0:4,1]+revenue[0:4, 0],color='blue', label=categories[2])
