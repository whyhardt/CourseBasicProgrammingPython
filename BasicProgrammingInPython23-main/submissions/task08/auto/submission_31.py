...
plt.plot(days, temperature, color='m')
...
revenueNew= revenue.T


plt.bar(regions, revenueNew[0], color='r', label='Electronics')
plt.bar(regions, revenueNew[1], bottom=revenueNew[0], color='g', label='Clothes')
plt.bar(regions, revenueNew[2], bottom=revenueNew[0]+revenueNew[1], color='b', label='Books')
