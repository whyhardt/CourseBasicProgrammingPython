...
plt.title("Number of steps taken over the week")
...
plt.bar(regions, revenue[:,0], color="red")
plt.bar(regions, revenue[:,1], bottom=revenue[:,0], color="green")
...
plt.xlabel("regions")
plt.ylabel("revenue")
legend = [plt.Rectangle((0,0),1,1,color="red"),
          plt.Rectangle((0,0),1,1,color="green"),
          plt.Rectangle((0,0),1,1,color="blue"),]
plt.legend(legend, categories)
