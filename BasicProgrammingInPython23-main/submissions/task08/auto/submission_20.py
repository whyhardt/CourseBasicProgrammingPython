...
plt.plot(weekdays, alice_steps, color='red', linestyle='--')
plt.plot(weekdays, bob_steps, color='blue', linestyle='--')
plt.plot(weekdays, carol_steps, color='green', linestyle='--')
