...
plt.plot(weekdays, alice_steps, color='red')
plt.plot(weekdays, bob_steps, color='blue')
plt.plot(weekdays, carol_steps, color='green')

# Legend
plt.legend()

# Axes labels and title
plt.title("Steps per Weekday")
plt.xlabel("Weekdays")
...
Student_1 = plt.Rectangle((0, 0), 1, 1, color='blue', alpha=0.7, label='Student 1')
Student_2 = plt.Rectangle((0, 0), 1, 1, color='green', alpha=0.7, label='Student 2')
fig.legend(handles=[Student_1, Student_2])
...
plt.bar(regions, revenue[:, 0], label=categories[0], color=colors[0])
plt.bar(regions, revenue[:, 1], label=categories[1], bottom=revenue[:, 0], color=colors[1])
plt.bar(regions, revenue[:, 2], label=categories[2], bottom=revenue[:, 0] + revenue[:, 1], color=colors[2])
...
# Create a legend
legend_elements = [plt.Rectangle((0, 0), 1, 1, color=color, label=category) for color, category in zip(colors, categories)]
