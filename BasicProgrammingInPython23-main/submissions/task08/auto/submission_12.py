...
student1_scores = np.random.normal(70, 10)  # Mean: 70, Standard Deviation: 10
student2_scores = np.random.normal(80, 8)   # Mean: 80, Standard Deviation: 8
...
plt.bar(regions, revenue[:, 0], color='grey', label=categories[0])
plt.bar(regions, revenue[:, 1], color='orange', label=categories[1])
plt.bar(regions, revenue[:, 2], color='green', label=categories[2])
