...
plt.plot(weekdays, alice_steps, marker='o', color='red', ls=':', label='Alice')
plt.plot(weekdays, bob_steps, marker='s',color='blue',ls='--', label='Bob')
plt.plot(weekdays, carol_steps, marker='^', color='green', label='Carol')
...
plt.title('The Steps Taken Throught The Weekdays')
...
revenue = np.array([[100, 150, 80,180],
                    [200, 120, 100,120],
                    [150, 80, 200, 90]])       

plt.bar(regions,revenue[0], label='Electronics', color='r')

plt.bar(regions,revenue[1], bottom=revenue[0], label='Clothing', color='g')

plt.bar(regions,revenue[2], bottom=revenue[0]+revenue[1], label='Books', color='b')
