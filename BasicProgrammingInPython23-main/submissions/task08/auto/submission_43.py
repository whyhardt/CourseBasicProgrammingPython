...
plt.bar(regions, revenue[:, 1], bottom=revenue[:, 0], label=categories[1], color=colors[1])
plt.bar(regions, revenue[:, 2], bottom=np.sum(revenue[:, :2], axis=1), label=categories[2], color=colors[2])
