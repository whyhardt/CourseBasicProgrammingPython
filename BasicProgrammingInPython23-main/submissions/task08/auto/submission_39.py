...
plt.plot(weekdays, alice_steps, color = 'red', linewidth=3.0, ls = "solid")
plt.plot(weekdays, bob_steps, color = 'blue', linewidth=3.0, ls = "solid")
plt.plot(weekdays, carol_steps, color = 'green', linewidth=3.0, ls = "solid")

# Legend
plt.legend()

# Axes labels and title
plt.title("Weekly Steps per Day of Students")
plt.xlabel("Days of the Week")
plt.ylabel("Steps")
...
fig.legend(["Student 1", "Student 2"], loc = "right")
