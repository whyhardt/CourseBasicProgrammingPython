...
plt.plot(weekdays, alice_steps,color="red", ls="-", lw= 1)
plt.plot(weekdays, bob_steps, color="blue", ls="-", lw= 1)
plt.plot(weekdays, carol_steps, color="green", ls="-", lw= 1)
...
plt.title("Number of steps each day")
plt.xlabel("Days of the week")
...
plt.bar(regions, revenue[:,0], color="blue", label="Electronics")
plt.bar(regions, revenue[:,1], bottom =revenue[:,0], color="red", label="Clothing")
plt.bar(regions, revenue[:,2], bottom =revenue[:,0]+revenue[:,1], color="green", label="Books")
