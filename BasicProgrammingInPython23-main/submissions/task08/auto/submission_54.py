...
axes[0].hist(student1_scores, bins=range(40, 101, bin_size_student1), color='blue', alpha=0.7)
...
for i in range(len(categories)):
    plt.bar(regions, revenue[:, i], bottom=np.sum(revenue[:, :i], axis=1), color=colors[i])

# Add a legend to display the color-product pairs
