...
temperature = np.random.uniform(20,31,size=7)
...
# Scatter plot
plt.scatter(weekdays, alice_steps, marker='o', c='red', label='Alice')
plt.scatter(weekdays, bob_steps, marker='s', c='blue', label='Bob')
plt.scatter(weekdays, carol_steps, marker='^', c='green', label='Carol')

# Line connecting scatterplot points
plt.plot(alice_steps, c='red')
plt.plot(bob_steps, c='blue')
plt.plot(carol_steps, c='green')
...
plt.bar(x=regions, height=revenue[:,0], bottom=0, label=categories[0])
plt.bar(x=regions, height=revenue[:,1], bottom=revenue[:,0], label=categories[1])
plt.bar(x=regions, height=revenue[:,2], bottom=revenue[:,1], label=categories[2])
