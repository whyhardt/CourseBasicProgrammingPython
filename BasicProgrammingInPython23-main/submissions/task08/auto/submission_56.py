...
plt.bar(regions, revenue[:, 0], color='red', edgecolor='black', width=bar_width, label=categories[0])
plt.bar(regions, revenue[:, 1], color='green', edgecolor='black', width=bar_width, bottom=revenue[:, 0], label=categories[1])
plt.bar(regions, revenue[:, 2], color='blue', edgecolor='black', width=bar_width, bottom=revenue[:, 0]+revenue[:, 1], label=categories[2])
